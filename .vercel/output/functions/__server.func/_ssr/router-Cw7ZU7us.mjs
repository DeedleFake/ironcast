...
import { N as require_react, c as HeadContent, d as Outlet, f as lazyRouteComponent, g as require_jsx_runtime, m as createRootRoute, p as createFileRoute, s as Scripts, u as createRouter } from "../_libs/@tanstack/react-router+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Cw7ZU7us.js
...
var styles_default = "/assets/styles-DuhUdRf7.css";
var APP_NAME = "Hellcast";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Doom-style raycast FPS with a built-in level editor and JSON import/export."
			},
			...[]
		],
		links: [{
			...
			rel: "stylesheet",
			href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;600&family=IBM+Plex+Sans+Condensed:wght@600;700&family=IBM+Plex+Sans:wght@400;500;600;700&display=swap"
		}]
	}),
...
var $$splitComponentImporter$1 = () => import("./routes-DllOd5v3.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-BOtHAupu.mjs");
